...
<figure><img src="../../.gitbook/assets/ZK Smart Contract Transaction.drawio.svg" alt=""><figcaption><p>A diagram illustrating the on-chain verification script (Plutus) for zkFold Symbolic smart contracts</p></figcaption></figure>
